...
@Component
public class DimTable extends BaseTestCase {
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		ctx.refresh();
		DimTableService dimTableService = (DimTableService) ctx.getBean("dimTableService");
		try {
			setupValues(context);
			results.sampleStart();
			mapResult = dimTableService.getCount();
