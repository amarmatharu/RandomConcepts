...
@Component
public class AggTable extends BaseTestCase {
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		ctx.refresh();
		AggTableService aggTableService = (AggTableService) ctx.getBean("aggTableService");
		try {
			setupValues(context);
			results.sampleStart();
			mapResult = aggTableService.getCount();
