...
@Component
public class FactView extends BaseTestCase {
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		ctx.refresh();
		FactViewService factViewService = (FactViewService) ctx.getBean("factViewService");
		try {
			setupValues(context);
			results.sampleStart();
			mapResult = factViewService.getCount();
